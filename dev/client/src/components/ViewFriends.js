        ...
        <>
          ...
          <div className="friends-container">
            ...
            <div className="friends-content">
              <h1 className="title title--myAcc">{username}'s Friends</h1>
              <form
              ...
              <h1 className="title title--friendReq">Friend Requests</h1>
                ...
                friendlist.map((friends) => (
                  <div key={friends.id}>
                    <ul>
                      ...
                      {friends.requested && (
                        <div>Friend Request has been sent.</div>
                      )}
                      {!friends.accepted && !friends.requested && (
                        <div>
                          <button
