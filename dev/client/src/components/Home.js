            ...
            {!isLoading && (
              <div className="search-view">
                ...
                <div className="item-view">
                  {!isLoading && !retrievedSearch && error_message == "" && (
                                    ...
                                    <div className="wishlist-data">
                                      ...
                                      {!item.addedToWishlist && (
                                        <button className="removed-from-wishlist">
                                          <i
                                            onClick={() =>
                                              this.handleAddToWishlist(item.id)
                                            }
                            ...
                            <div className="item-container">
                              ...
                              >
                                <div className="item-picture">
                                  ...
                                  ></img>
                                  <div className="item-picture__brand-logo">
                                    {recommendedItem.platform == "Shopee" && (
                                      <div className="item-picture__brand-logo__circle">
                                        <img
                                          width="45px"
                                          height="45px"
                                    ...
                                    {recommendedItem.platform == "Amazon" && (
                                      <div className="item-picture__brand-logo__circle">
                                        <img
                                          width="45px"
                                          height="45px"
                                    ...
                                    {recommendedItem.platform == "Lazada" && (
                                      <div className="item-picture__brand-logo__circle">
                                        <img
                                          width="45px"
                                          height="45px"
                                ...
                                <ul className="item-data">
                                  <li className="item-name">
                                    <p>{recommendedItem.item_name}</p>
                                  </li>

                                  <li className="price">
                                    {recommendedItem.item_price == -1 && (
                                      <div className="price-text">
                                        <div className="discounted-price">
                                          S${" "}
                                  ...
                                  <li className="deliveryfee">
                                    <i class="fa-solid fa-truck"></i>{" "}
                                    {recommendedItem.deliveryFee == 0.0 && (
                                      <div className="deliveryfee-text">
                                        Free
                                        <p>(Subject to platform T&C)</p>
                                      </div>
                                    ...
                                    {recommendedItem.deliveryFee != 0.0 && (
                                      <div className="deliveryfee-text">
                                        S$
                                        {"    "}
                                        {recommendedItem.deliveryFee.toFixed(2)}
                                      </div>
                                    )}
                                  </li>
                                  <li className="rating">
                                    <div className="rating-prop">
                                      <i className="fa-solid fa-star"></i>
                                      <div className="rating-text">
                                        {recommendedItem.rating.toFixed(2)} (
                                        {recommendedItem.numOfRating} reviews)
                                      </div>
                                    </div>
                                  </li>
                                  <li className="item-url">
                                    <button className="btn btn-positive visit-link-button">
                                      <a href={recommendedItem.item_url}>
                                        <p>Buy</p>
                                      </a>
                                    </button>
                                  </li>
